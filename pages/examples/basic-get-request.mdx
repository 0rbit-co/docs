...
### Command to interact with the `ao` processes
    ...
    #### Create a variable
    ```bash
    GET_0RBIT= "WSXUI2JjYUldJ7CKq9wE1MGwXs-ldzlUlHOQszwQe0s"
    ```
    This will create a variable `GET_0RBIT` and assign the value of the process ID of the __0rbit's GET `ao` process__.
