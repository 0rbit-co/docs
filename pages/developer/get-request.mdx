...
| `X-Min-Fee` | The minimum fee you are willing to pay for the request. | Currently Optional |
| `X-Max-Fee` | The maximum fee you are willing to pay for the request. | Currently Optional |
| `X-Valid-For` | The time for which the request is valid. | Currently Optional |
