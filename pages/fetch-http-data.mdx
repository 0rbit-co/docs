...
# Fetch HTTP Data Docs

**0rbit** helps in bringing any data from both off-chain and on-chain world, and to bring better DevX we have built a simple HTTP function within our **main `ao` process** to fetch data from any HTTP endpoint.
